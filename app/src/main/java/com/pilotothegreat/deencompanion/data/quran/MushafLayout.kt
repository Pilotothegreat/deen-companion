...
/** Standard Madinah mushaf (Hafs) layout: where each of the 604 pages and 30 juz begins. */
internal object MushafLayout {
    ...
    /** Ayahs with a prostration of recitation (sajdat al-tilawah). */
    val sajdahs: Set<Pair<Int, Int>> = setOf(
