...
- **Settings you can read.** Six groups and about thirty rows, each describing what a feature does for you rather than which service its data comes from. Provenance lives in [ATTRIBUTION.md](ATTRIBUTION.md) and [PRIVACY.md](PRIVACY.md), where it belongs.
